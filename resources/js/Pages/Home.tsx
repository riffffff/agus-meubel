    ...
    return (
        <PublicLayout>
            ...
            {safeHeroArticles.length > 0 ? (
                ...
                <div className="relative bg-stone-900 overflow-hidden py-20 sm:py-28">
                    ...
                    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white space-y-5">
                        <span className="bg-amber-900/80 text-stone-100 text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-md border border-amber-700/50">
                        ...
                        <div className="flex justify-center gap-3 pt-3">
                            <Link href={route('products.index')} className="px-6 py-3 bg-amber-900 hover:bg-amber-800 text-stone-100 font-bold rounded-xl shadow-md transition text-sm">
                                Jelajahi Produk
                            </Link>
                            <a href={`https://wa.me/${waNumber}`} target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-stone-100 hover:bg-stone-200 text-stone-900 font-bold rounded-xl shadow-md transition text-sm">
                                Konsultasi Custom
                            </a>
                        </div>
                    </div>
            ...
            <section className="py-12 bg-stone-100 border-y border-stone-200/50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-white p-6 rounded-2xl border border-stone-200/60 shadow-xs flex gap-4 items-start">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {safeReviews.map((rev) => {
                                ...
                                return (
                                    <div key={revId} className="bg-white p-6 rounded-2xl border border-stone-200/60 shadow-xs flex flex-col justify-between">
