                            ...
                            {articlesData.map((article, index) => {
                                ...
                                return (
                                    <ScrollReveal key={artId} delay={(index % 3) * 150} direction="up">
                                        <article className="group bg-white rounded-2xl overflow-hidden border border-stone-200/60 shadow-sm hover:shadow-xl hover:border-amber-900/20 hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
